...
const TotalTestTimer: React.FC<TotalTestTimerProps> = ({ 
  ...
  }, [startTime, isTestComplete, onTimeUpdate, totalQuestions]);
  
  // Calculate total allowed time (60 seconds per question)
  const totalAllowedTime = 60 * totalQuestions;
  
  // Remaining time for the test
  const remainingTime = totalAllowedTime - elapsedTime;
